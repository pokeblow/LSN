...
class TransUnet(nn.Module):
    def __init__(self, img_dim=128, in_channels=1, out_channels=128, head_num=4, mlp_dim=512, block_num=8, patch_dim=8, class_num=1):
        super().__init__()

        # img_dim=128, in_channels=1, out_channels=128, head_num=4, mlp_dim=512, block_num=8, patch_dim=16, class_num=1
